...
public final class Nullable<T> {
    ...
    /**
     * If a value is present in this {@code Nullable}, returns the {@code value}. If
     * no value is present, returns {@code null}.
     * <p>
     * Ideally, {@code unwrap()} should be terminal method in the method chain to
     * ensure null safety.
     * <p>
     * Wrong Usage:
     * <p>
     * <code>
     *     Integer length = Nullable.of("abc").unwrap().length();
     * </code>
     * <p>
     * Correct Usage:
     * <p>
     * <code>
     *     Integer length = Nullable.of("abc").map(String::length).unwrap();
     * </code>
     *
     * @return the {@code value} held by this {@code Nullable}, or {@code null} if
     *         no value is present
     */
