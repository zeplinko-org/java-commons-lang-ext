...
/**
 * A generic class for wrapping the result of an operation that can either succeed or fail. This class holds either data
 * (on success) or an error object (on failure), but not both. Use static factory methods {@code ok} and {@code error}
...
public class Result<S, T> {
    /**
     * The data of the operation if it succeeded. This field is null in case of failure.
     */
    private final S data;

    /**
     * The error object of the operation if it failed. This field is null in case of success.
     */
    ...
    /**
     * Returns the data if the result is successful; otherwise, returns the other specified value.
     *
    ...
    /**
     * Returns the data if the result is successful; otherwise, applies the provided function to the error and returns the result.
     *
     * @param otherFunction The function to apply to the error if the result is a failure.
     * @return The success data, or the result of applying {@code otherFunction} to the error.
     */
    ...
    /**
     * Returns the data if the result is successful; otherwise, throws the exception provided by the function applied to the error.
     *
     * @param exceptionFunction The function to apply to the error to generate an exception.
     * @param <X> The type of the exception to be thrown if the result is a failure.
     * @return The success data.
     * @throws X if the result is a failure, the exception generated by applying {@code exceptionFunction} to the error.
     */
