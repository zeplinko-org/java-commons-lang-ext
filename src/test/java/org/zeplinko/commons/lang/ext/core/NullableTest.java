...
class NullableTest {
    ...
    @Test
    void unwrapValueTest() {
        Nullable<String> nullable1 = Nullable.of("abc");
        Nullable<String> nullable2 = Nullable.empty();

        Assertions.assertNotNull(nullable1.unwrap());
        Assertions.assertNull(nullable2.unwrap());
    }
    ...
    void mapNullableWithNonNullValueTest() {
        ...
        Assertions.assertNotNull(integerNullable.unwrap());
    }
    ...
    void mapNullableWithNullValueTest() {
        ...
        Assertions.assertNotNull(integerNullable);
        Assertions.assertNull(integerNullable.unwrap());
    }
    ...
    void orNullableWithNonNullValueTest() {
        ...
        Assertions.assertNotNull(nullable3.unwrap());
        Assertions.assertEquals("abc", nullable3.unwrap());
    }
    ...
    void orNullableWithNullValueTest() {
        ...
        Assertions.assertNotNull(nullable3);
        Assertions.assertNotNull(nullable3.unwrap());
        Assertions.assertEquals("def", nullable3.unwrap());
    }
